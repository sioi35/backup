...
@WebServlet("/main/member/mypage/ongoingstudy.do")
public class OngoingStudy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//진행중인 스터디 공고 목록 가져오기
		ArrayList<StudyDTO> slist = dao.getOngoingStudy(memberseq);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/main/member/mypage/ongoingstudy.jsp");
