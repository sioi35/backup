...
<body>
	...
	<section class="container" style="width:1050px; height:auto;">
		...
		<div style="display:flex;">
		 ...
		 <form method="POST" action="/webproject/main/member/community/license.do">
		...
		<div style="display:flex;">
      		...
      		<ul class="nav" style="width:140px;">      			
      			...
      			<li id= "license" onclick="location.href='/webproject/main/member/community/license.do';"  style="color: #548CA8;
font-size: 23px;">자격증 정보</li>
         ...
         <button type="button" class="btn btn11" name="orderReadCount" value="readCount">조회순</button>
			<div class="searchbox">
		         ...
		         -->
		         <form method="GET" action="/webproject/main/member/community/license.do">
   ...
   <script>
		 ...
		 $('#selPage').change(function(){
		      location.href='/webproject/main/member/community/license.do?page=' + $(this).val();
		   ...
		   $("button[name=orderRegdate]").click(function () {
		         location.href='/webproject/main/member/community/license.do?orderRegdate=regdate';
		      })
		      
		      $("button[name=orderRecommendCount]").click(function () {
		         location.href='/webproject/main/member/community/license.do?orderRecommendCount=recommendCount';
		      })
		      
		      $("button[name=orderComment]").click(function () {
		         location.href='/webproject/main/member/community/license.do?orderComment=ccnt';
		      })
		      
		      $("button[name=orderReadCount]").click(function () {
		         location.href='/webproject/main/member/community/license.do?orderReadCount=readCount';
		      })
