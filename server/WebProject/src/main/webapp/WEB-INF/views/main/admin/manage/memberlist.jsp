...
<body>
	...
	<section class="main-section">
		...
		<div class="aaa">
			...
			<div class="ddd">
				<form action="/webproject/main/admin/manage/memberlist.do" method="GET">
			...
			<c:forEach items="${list}" var="dto">
				<c:if test="${dto.score != null}">
					<div class="fff">
						<div class="hhh">
							<span style="margin-right: 5px;">${dto.name}</span>
							<c:choose>
							...
							<div class="ggg">
								<span>
									<input type="button" value="기본정보 자세히보기" class="btn btn-primary" onclick="location.href='/webproject/main/admin/manage/accountview.do?memberSeq=${dto.memberSeq}'" />
								</span>
								<span>
									<input type="button" value="프로필 자세히보기" class="btn btn-primary" onclick="location.href='/webproject/main/admin/manage/profileview.do?memberSeq=${dto.memberSeq}'" />
								</span>
							</div>
						</div>
					</div>
