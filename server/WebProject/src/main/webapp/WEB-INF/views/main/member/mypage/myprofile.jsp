...
<body>
   ...
   <script>
   		...
   		$('#gender').val("${myProfileList.gender}");
 		$('#career').val("${myProfileList.career}");
 		$("#academicBackground").val("${myProfileList.academicBackground}")
 		$("#interestOccupation").val("${myProfileList.interestOccupation}")
 		$("#availableLanguage").val("${myProfileList.availableLanguage}")
 		$("#major").val("${myProfileList.major}")
