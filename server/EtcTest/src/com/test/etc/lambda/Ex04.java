...
public class Ex04 {
	...
	private static void m5() {
		...
		// 5. Predicate: 매개변수O, 반환값O > 매개변수를 논리 연산 후 결과 반환 > Function 하위 버전
		// - 매개변수의 값을 받아 무언가를 조사한 후 논리값을 반환한다.
		// - testXXX()
